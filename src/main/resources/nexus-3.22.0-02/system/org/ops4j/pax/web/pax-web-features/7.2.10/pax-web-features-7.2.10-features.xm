...
<features name="org.ops4j.pax.web-7.2.10" xmlns="http://karaf.apache.org/xmlns/features/v1.3.0">

    <feature name="pax-web-core" description="Provide Core pax-web bundles" version="7.2.10">
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-api/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-spi/7.2.10</bundle>
        ...
        <bundle dependency="true">mvn:org.apache.xbean/xbean-bundleutils/4.12</bundle>
        <bundle dependency="true">mvn:org.apache.xbean/xbean-reflect/4.12</bundle>
        <bundle dependency="true">mvn:org.apache.xbean/xbean-finder/4.12</bundle>
    </feature>

    <feature name="pax-jetty" description="Provide Jetty engine support" version="9.4.18.v20190429">
    ...
    <feature name="pax-jetty-http2" version="7.2.10" description="Optional additional feature to run Jetty with SPDY">
    	<details>
		...
		<bundle start-level="1">mvn:org.eclipse.jetty.osgi/jetty-osgi-alpn/9.4.18.v20190429</bundle>
		<bundle start-level="30">mvn:org.eclipse.jetty.alpn/alpn-api/1.1.2.v20150522</bundle>
        <bundle start-level="30">mvn:org.eclipse.jetty/jetty-alpn-server/9.4.18.v20190429</bundle>
        <bundle start-level="30">mvn:org.eclipse.jetty.http2/http2-server/9.4.18.v20190429</bundle>
        <bundle start-level="30">mvn:org.eclipse.jetty.http2/http2-common/9.4.18.v20190429</bundle>
        <bundle start-level="30">mvn:org.eclipse.jetty.http2/http2-hpack/9.4.18.v20190429</bundle>
    </feature>

    <feature name="pax-http-jetty" version="7.2.10">
        <configfile finalname="${karaf.etc}/jetty.xml">mvn:org.ops4j.pax.web/pax-web-features/7.2.10/xml/jettyconfig</configfile>
        ...
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-runtime/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-jetty/7.2.10</bundle>
    ...
    <feature name="pax-http" version="7.2.10" description="Implementation of the OSGI HTTP Service">
    ...
    <feature name="pax-http-whiteboard" description="Provide HTTP Whiteboard pattern support" version="7.2.10">
        ...
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-jsp/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-extender-whiteboard/7.2.10</bundle>
    ...
    <feature name="pax-war" description="Provide support of a full WebContainer" version="7.2.10">
        <config name="org.ops4j.pax.url.war">
            org.ops4j.pax.url.war.importPaxLoggingPackages=true
        </config>
        <feature version="[7.2,7.3)">pax-http-whiteboard</feature>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-descriptor/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-extender-war/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-extender-whiteboard/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-deployer/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.url/pax-url-war/2.6.1/jar/uber</bundle>
    </feature>

    <feature name="pax-http-tomcat" description="Provide Tomcat support" version="7.2.10">
        <config name="org.ops4j.pax.url.war">
            org.ops4j.pax.url.war.importPaxLoggingPackages=true
        </config>
        <config name="org.ops4j.pax.web">
        ...
        <feature>pax-web-core</feature>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-runtime/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-tomcat/7.2.10</bundle>
        <bundle start-level="30">mvn:org.ops4j.pax.web/pax-web-jsp/7.2.10</bundle>
    ...
    <feature name="pax-jsf-resources-support" description="Provide sharing of resources according to Servlet 3.0 for OSGi bundles and JSF" version="7.2.10">
        <feature version="[7.2,7.3)">pax-jsf-support</feature>
        <bundle dependency="true">mvn:org.ops4j.pax.web/pax-web-resources-extender/7.2.10</bundle>
        <bundle>mvn:org.ops4j.pax.web/pax-web-resources-jsf/7.2.10</bundle>
    </feature>
    ...
    <feature name="pax-http-undertow" version="7.2.10">
        <configfile finalname="${karaf.etc}/undertow.properties">mvn:org.ops4j.pax.web/pax-web-features/7.2.10/properties/undertowconfig</configfile>
        <configfile finalname="${karaf.etc}/undertow.xml">mvn:org.ops4j.pax.web/pax-web-features/7.2.10/xml/undertowconfig</configfile>
        <config name="org.ops4j.pax.web">
            org.osgi.service.http.port=8181
            javax.servlet.context.tempdir=${karaf.data}/pax-web-jsp
        ...
        <feature>pax-web-core</feature>
        <bundle>mvn:org.ops4j.pax.web/pax-web-runtime/7.2.10</bundle>
        <bundle>mvn:org.ops4j.pax.web/pax-web-undertow/7.2.10</bundle>
